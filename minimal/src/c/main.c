// Minimal Watchface by szala - 2016
...
void tick_handler(struct tm *tick_time, TimeUnits units_changed)
{
	...
	strftime(buffer3, sizeof("Xxx 00 Xxx"), "%a %e %b", tick_time);
...
//	text_layer_set_text(date_layer, "Wed 29 May");
}
...
void window_load(Window *window) {
	...
	//Cell layers
	day_one = bitmap_layer_create(GRect(2, 2, 14, 6));
	day_two = bitmap_layer_create(GRect(23, 2, 14, 6));
	day_three = bitmap_layer_create(GRect(44, 2, 14, 6));
	day_four = bitmap_layer_create(GRect(65, 2, 14, 6));
	day_five = bitmap_layer_create(GRect(86, 2, 14, 6));
	day_six = bitmap_layer_create(GRect(107, 2, 14, 6));
	day_seven = bitmap_layer_create(GRect(128, 2, 14, 6));
